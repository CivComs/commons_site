...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Dependency.type'
        db.alter_column('commons_core_dependency', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['commons_core.DependencyType'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Dependency.type'
        raise RuntimeError("Cannot reverse this migration. 'Dependency.type' and its values cannot be restored.")
