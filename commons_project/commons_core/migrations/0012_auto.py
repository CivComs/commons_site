...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field usesapps on 'CCProfile'
        db.create_table('commons_core_ccprofile_usesapps', (
        ...
        db.create_unique('commons_core_ccprofile_usesapps', ['ccprofile_id', 'app_id'])

        # Adding M2M table for field contributestoapps on 'CCProfile'
        db.create_table('commons_core_ccprofile_contributestoapps', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ccprofile', models.ForeignKey(orm['commons_core.ccprofile'], null=False)),
            ('app', models.ForeignKey(orm['commons_core.app'], null=False))
        ))
        db.create_unique('commons_core_ccprofile_contributestoapps', ['ccprofile_id', 'app_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field usesapps on 'CCProfile'
        db.delete_table('commons_core_ccprofile_usesapps')

        # Removing M2M table for field contributestoapps on 'CCProfile'
        db.delete_table('commons_core_ccprofile_contributestoapps')
    ...
    models = {
        ...
        'commons_core.ccprofile': {
            ...
            'contributestoapps': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'contributors'", 'symmetrical': 'False', 'to': "orm['commons_core.App']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'usesapps': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'users'", 'symmetrical': 'False', 'to': "orm['commons_core.App']"})
        },
