...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CCProfile.bio'
        db.add_column('commons_core_ccprofile', 'bio', self.gf('django.db.models.fields.TextField')(default='', max_length=500), keep_default=False)

        # Adding field 'CCProfile.location'
        db.add_column('commons_core_ccprofile', 'location', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)
        ...
        # Adding field 'CCProfile.title'
        db.add_column('commons_core_ccprofile', 'title', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CCProfile.bio'
        db.delete_column('commons_core_ccprofile', 'bio')

        # Deleting field 'CCProfile.location'
        db.delete_column('commons_core_ccprofile', 'location')

        # Deleting field 'CCProfile.affiliation'
        db.delete_column('commons_core_ccprofile', 'affiliation_id')

        # Deleting field 'CCProfile.title'
        db.delete_column('commons_core_ccprofile', 'title')
