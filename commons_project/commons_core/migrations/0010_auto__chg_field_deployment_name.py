...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Deployment.name'
        db.alter_column('commons_core_deployment', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'Deployment.name'
        db.alter_column('commons_core_deployment', 'name', self.gf('django.db.models.fields.TextField')())
