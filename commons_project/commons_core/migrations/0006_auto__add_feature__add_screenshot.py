...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('commons_core_feature', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('feature', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal('commons_core', ['Feature'])

        # Adding model 'Screenshot'
        db.create_table('commons_core_screenshot', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True, blank=True)),
        ))
        db.send_create_signal('commons_core', ['Screenshot'])

        # Adding M2M table for field screenshots on 'App'
        db.create_table('commons_core_app_screenshots', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('app', models.ForeignKey(orm['commons_core.app'], null=False)),
            ('screenshot', models.ForeignKey(orm['commons_core.screenshot'], null=False))
        ))
        db.create_unique('commons_core_app_screenshots', ['app_id', 'screenshot_id'])

        # Adding M2M table for field features on 'App'
        db.create_table('commons_core_app_features', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('app', models.ForeignKey(orm['commons_core.app'], null=False)),
            ('feature', models.ForeignKey(orm['commons_core.feature'], null=False))
        ))
        db.create_unique('commons_core_app_features', ['app_id', 'feature_id'])


    def backwards(self, orm):
        
        # Deleting model 'Feature'
        db.delete_table('commons_core_feature')

        # Deleting model 'Screenshot'
        db.delete_table('commons_core_screenshot')

        # Removing M2M table for field screenshots on 'App'
        db.delete_table('commons_core_app_screenshots')

        # Removing M2M table for field features on 'App'
        db.delete_table('commons_core_app_features')
