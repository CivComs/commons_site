...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CCProfile.affiliation'
        db.delete_column('commons_core_ccprofile', 'affiliation_id')

        # Adding M2M table for field affiliations on 'CCProfile'
        db.create_table('commons_core_ccprofile_affiliations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ccprofile', models.ForeignKey(orm['commons_core.ccprofile'], null=False)),
            ('jurisdiction', models.ForeignKey(orm['commons_core.jurisdiction'], null=False))
        ))
        db.create_unique('commons_core_ccprofile_affiliations', ['ccprofile_id', 'jurisdiction_id'])


    def backwards(self, orm):
        
        # Adding field 'CCProfile.affiliation'
        db.add_column('commons_core_ccprofile', 'affiliation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['commons_core.Jurisdiction'], null=True, blank=True), keep_default=False)

        # Removing M2M table for field affiliations on 'CCProfile'
        db.delete_table('commons_core_ccprofile_affiliations')
    ...
    models = {
        ...
        'commons_core.ccprofile': {
            ...
            'affiliations': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'users'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['commons_core.Jurisdiction']"}),
            'bio': ('django.db.models.fields.TextField', [], {'default': "''", 'max_length': '500'}),
            'contributestoapps': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'contributors'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['commons_core.App']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'usesapps': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'users'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['commons_core.App']"})
        },
