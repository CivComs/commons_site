...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CCProfile'
        db.create_table('commons_core_ccprofile', (
        ...
        db.send_create_signal('commons_core', ['CCProfile'])


    def backwards(self, orm):
        
        # Deleting model 'CCProfile'
        db.delete_table('commons_core_ccprofile')
