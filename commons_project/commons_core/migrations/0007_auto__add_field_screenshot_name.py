...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('commons_core_screenshot', 'name', self.gf('django.db.models.fields.TextField')(default='blank'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Screenshot.name'
        db.delete_column('commons_core_screenshot', 'name')
