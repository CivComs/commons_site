...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('commons_core_app', 'ssid_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['commons_core.SSProduct'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'App.ssid'
        raise RuntimeError("Cannot reverse this migration. 'App.ssid' and its values cannot be restored.")
